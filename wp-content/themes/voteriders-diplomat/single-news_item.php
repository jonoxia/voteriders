...
if (have_posts()) {
  ...
  <?php              
                ...
                $value = types_render_field( "title" );
		  $pubURL = types_render_field( "url" );
		$pubDate = types_render_field("publicationdate");

if( $value ) {

   
    echo '<a href="' . $pubURL  . '" target="_blank">'. $value . '</a>, &nbsp;' . get_the_date();
...
?>
			    ...
			    <div class="entry-content">
					...
					if( !the_content()){
				    		echo types_render_field("excerpt");
					}else{
						the_content();
						...
						echo '<a href="'. $articleLink .'"> Read the full article...</a>';
